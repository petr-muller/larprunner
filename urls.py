...
urlpatterns = patterns('larprunner',  
  ...
  (r'^admin/users/{0,1}(sort(?P<sort>\w+)){0,1}/{0,1}$',   'admin.users_views.list_users'),
  ...
  (r'^admin/events/(single|multi)/(?P<eventid>\d{1,3})/people/sort_(?P<sorted>.+)/{0,1}$', 'admin.events_views.show_applied_people'),
  ...
  (r'^admin/events/multi/(?P<eventid>\d{1,3})/people/wslots/sort_(?P<sorted>.*)/{0,1}$', 'admin.events_views.show_applied_people', {'slotted' : True}),
